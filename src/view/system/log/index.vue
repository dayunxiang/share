  ...
  <div>
    ...
    <div class="main-container">
        ...
        <div>
          <el-row :gutter="15">
            ...
            <el-col :span="8" class="height-28"  v-if="tabNum == 2">
              ...
              <el-date-picker
                v-model="createDataTime"
                type="daterange"
                start-placeholder="开始日期"
                end-placeholder="结束日期"
                @change="changeDataCreateTime"
                value-format="yyyy-MM-dd HH:mm:ss" size="mini"
                class="form-input">
              </el-date-picker>
            </el-col>
            ...
            <el-col :span="8" class="height-28"  v-if="tabNum == 3">
              ...
              <el-date-picker
                v-model="createDocTime"
                type="daterange"
                start-placeholder="开始日期"
                end-placeholder="结束日期"
                @change="changeDocCreateTime"
                value-format="yyyy-MM-dd HH:mm:ss" size="mini"
                class="form-input">
              </el-date-picker>
            </el-col>
      ...
      <el-table :data="list" border v-show="tabNum == 1">
        ...
        <el-table-column label="订阅时间" prop="apiBoughtTime"  ></el-table-column>
        ...
        <el-table-column label="使用/订阅次数" prop="applicantDate"  >
          <template slot-scope="scope">
            <span>{{scope.row.apiCallTimes}} / {{scope.row.apiBookedTimes}}</span>                     
          </template>
        </el-table-column>
...
<script>
  import {getApiLogList, getDataLogList, getDocLogList, changeApiStatus} from '@/api/system/index';
  export default {
    name: 'systemLog',
    components: {
    },
