    ...
    <div class="main-container"> 
      <div class="detail-container">
        ...
        <el-row>
          ...
          <el-col :span="5">
            <label>状态:</label>
            <span v-if="data.status == '1'" class="text-red">待受理</span>
            <span v-if="data.status == '2'" class="text-blue">待回复</span>
    ...
    <div class="main-container" v-if="tabNum == 1 || tabNum == 2"> 
      <div class="detail-container">
        <el-row>
          ...
          <el-col :span="20">
            <el-input type="textarea" class="quesDesc" v-model="content"></el-input>
          </el-col>
        </el-row>
      </div>
    </div>
